    ...
    <!-- main -->
		...
		<div class="colorlib-shop">
			<div class="container">
				...
				<div class="row">
                    @foreach ($product_fe as $prd_fe)
                    <div class="col-md-3 text-center">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(../backend/img/{{ $prd_fe->img }});">

								<div class="cart">
									<p>
										<span class="addtocart"><a href="/product/detail/{{ $prd_fe->id }}"><i class="icon-shopping-cart"></i></a></span>
										<span><a href="/product/detail/{{ $prd_fe->id }}"><i class="icon-eye"></i></a></span>
							...
							<div class="desc">
								<h3><a href="/product/detail/{{ $prd_fe->id }}">{{ $prd_fe->name }}</a></h3>
								<p class="price"><span>{{ number_format($prd_fe->price,0,'','.') }} VNĐ</span> </p>
							</div>
						</div>
					</div>
                    @endforeach
		...
		<div class="colorlib-shop">
			<div class="container">
				...
				<div class="row">
                    ...
                    <div class="col-md-3 text-center">
						<div class="product-entry">
							<div class="product-img" style="background-image: url(../backend/img/{{ $prd_new->img }});">
